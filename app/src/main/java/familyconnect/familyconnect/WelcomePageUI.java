 ...
 */
public class WelcomePageUI extends AppCompatActivity implements View.OnClickListener, GoogleApiClient.OnConnectionFailedListener {


    private TextView name, email;
    private ImageView picture;
 //   private Button buttonLogout, buttonFetch, buttonPost, buttonPut, buttonDelete;
    private Button buttonLogout, buttonMyGroup, buttonAddMembers, buttonEditActivities, buttonDelete;
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            //edit the following for a user friendly UI
    ...
    private void updateUI(boolean isLogin) {
        ...
        Intent signInPage = new Intent(WelcomePageUI.this, Login.class);
        WelcomePageUI.this.startActivity(signInPage);
    }
